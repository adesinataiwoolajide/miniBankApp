    ...
    <div class="container-fluid">
        <div class="row pt-2 pb-2">
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/administrator/account_officer/edit/${office.officerid}">Edit Account Officer</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form To Update Account Officer </div>
                    <div class="card-body">
                        <form action="/administrator/account_officer/update" method="POST" enctype="multipart/form-data">

                            <div class="form-group row ">
                                <div class="col-sm-8">

                                    <input type="text" class="form-control form-control-rounded" name="officername" required
                                           placeholder="Enter The Account Officer Name" value="${office.officername}">

                                    <span id="officername.errors" class="error">${officername.errors}</span>
                                </div>
                                <input type="hidden" name="officerid" value="${office.officerid}">

                                <div class="col-sm-4" align="center">
                                    <button type="submit" class="btn btn-success btn-lg btn-block" role="" >
                                        UPDATE THE ACCOUNT OFFICER
                                    </button>
                                </div>
                            </div>
                        </form>
