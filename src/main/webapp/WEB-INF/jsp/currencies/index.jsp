    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form To Add New Currency </div>
                    <div class="card-body">
                        <form action="/administrator/currency/save" method="POST" enctype="multipart/form-data">

                            <div class="form-group row ">
                                <div class="col-sm-6">
                                    <label>Currency Name </label>
                                    <input type="text" class="form-control form-control-rounded" name="currencyname"
                                           required
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control form-control-rounded"
                                           name="currencymnemonic" required
                                           placeholder="Enter The Currency Mnemonic">
                                    <span style="color: red">** This Field is Required **</span>
