        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/administrator/account_category/update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row ">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control form-control-rounded" name="accountcategoryname" required
                                           placeholder="Enter The Account Category Name" value="${category.accountcategoryname}">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" class="form-control form-control-rounded" name="amount" required
                                           placeholder="Enter The Amount" value="${category.amount}">
                                    <span style="color:color: red">** This Field is Required **</span>
                                </div>
                                <input type="hidden" name="accountcategoryid" value="${category.accountcategoryid}">
