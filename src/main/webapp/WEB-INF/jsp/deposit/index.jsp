...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form To Add New Deposite </div>
                    <div class="card-body">
                        <form action="/administrator/deposite/save" method="POST" enctype="multipart/form-data">

                            <div class="form-group row ">
                                <div class="col-sm-6">
                                    <label>Account Number </label>
                                    <input type="text" class="form-control form-control-rounded" name="" required
                                           placeholder="Enter The Account Number" value="${accounts.accountnumber}" readonly>
                                    <span style="color: red">** This Field is Required **</span>
                                </div>
                                <div class="col-sm-6" id="txtHint2">
                                    <label>Customer Name </label>
                                    <input type="text" class="form-control form-control-rounded" name="" required
                                           placeholder="Enter The Amount" value="${customer.customername}" readonly>
                                    <span style="color: red">** This Field is Required **</span>
                                </div>
                                <input type="hidden" name="accountid" value="${account.accountid}">
                                <input type="hidden" name="accountnumber" value="${accounts.accountnumber}">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" class="form-control form-control-rounded" name="senderphone" required
                                           placeholder="Enter The Sender Phone">
                                    <span style="color: red">** This Field is Required **</span>
                                </div>

                                <div class="col-sm-12" align="center">
                                    <button type="submit" id="" class="btn btn-success btn-lg btn-block" >CREATE THE DEPOSITE
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="default-datatable" class="table table-bordered">
                                ...
                                <tbody>
                                <c:forEach var="accounts" items="${deposite}" >
                                    <tr>
                                        <td>
